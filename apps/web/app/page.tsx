...
export default function Home() {
  ...
  const fetchVideos = useCallback(async () => {
    try {
      ...
      setVideos((prev) => {
        ...
        const serverItems = data.filter(
          (v: VideoItem) => !uploadingItems.find((u) => u.id === v.id)
        )
  ...
  return (
    ...
    <div className="flex min-h-screen flex-col bg-zinc-950 font-sans selection:bg-emerald-500/30">
      <main className="relative z-10 mt-10 flex flex-1 flex-col items-center p-6 sm:p-12">
